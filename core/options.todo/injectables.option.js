...
class TInjectables extends decorator_option_1.default {
    constructor(key, targetName, dependencies) {
        super(key, targetName, dependencies);
        this.kind = behaviours_1.INJECTABLE;
        this.setValidation({
...
exports.default = TInjectables;
TInjectables.dependsOn = behaviours_1.RESOLVABLE;
//# sourceMappingURL=injectables.option.js.map